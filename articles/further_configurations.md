...
#> Log file set to /tmp/RtmpnaTP7w/logfile.log
loggit2::loggit(
  log_lvl = "DEBUG",
  log_msg = "This message will be logged to `logfile.log`."
)
#> {"timestamp": "2025-11-24T02:49:07+0000", "log_lvl": "DEBUG", "log_msg": "This message will be logged to `logfile.log`."}
...
#> {"timestamp": "2025-11-24T02:49:08+0000", "log_lvl": "DEBUG", "log_msg": "This message will be logged to `otherlogfile.log`."}


loggit2::with_loggit(logfile = "logfile2.log", {
  base::message("This message will be logged to `logfile2.log`.")
})
#> {"timestamp": "2025-11-24T02:49:08+0000", "log_lvl": "INFO", "log_msg": "This message will be logged to `logfile2.log`.\n"}
#> This message will be logged to `logfile2.log`.

loggit2::set_logfile(old_log)
#> Log file set to /tmp/RtmpnaTP7w/loggit.log
```
...
#> {"timestamp": "2025-11-24T02:49:08+0000", "log_lvl": "INFO", "log_msg": "This message will be logged, since the log level is INFO.\n"}
...
#> {"timestamp": "2025-11-24T02:49:08+0000", "log_lvl": "DEBUG", "log_msg": "This message will be logged because the log level is ignored."}
loggit2::warning(
...
#> {"timestamp": "2025-11-24T02:49:08+0000", "log_lvl": "INFO", "log_msg": "This message will be logged, since .loggit = TRUE.\n"}
...
#> {"timestamp": "2025-11-24T02:49:08+0000", "log_lvl": "ERROR", "log_msg": "This error message will be logged because the log level is set to ERROR."}
...
#> {"timestamp": "2025-11-24T02:49:08+0000", "log_lvl": "INFO", "log_msg": "This message will be logged because the log level is set to DEBUG.\n"}
...
#> {"timestamp": "2025-11-24T02:49:08+0000", "log_lvl": "INFO", "log_msg": "This message will be logged and output to the console.\n"}
...
#> Current time in this format: 02:49:08
loggit2::message("This message will be logged with a timestamp in the format HH:MM:SS.")
#> {"timestamp": "02:49:08", "log_lvl": "INFO", "log_msg": "This message will be logged with a timestamp in the format HH:MM:SS.\n"}
...
#> Current time in this format: 2025-11-24T02:49:08+0000
```
