...
Usage
--------------
`loggit2` provides a set of wrappings for base R's `message()`, `warning()`, `stop()` and `stopifnot()`
functions that maintain identical functionality, making it sufficient to
